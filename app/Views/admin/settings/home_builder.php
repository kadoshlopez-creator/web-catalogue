...
<script>
    ...
    function getTemplateHTML(templateId) {
        const templates = {
            // CONTACTO
            contact_1: `<section class="py-16 px-4 max-w-2xl mx-auto"><h1 class="text-3xl font-bold text-gray-900 mb-4">Contáctanos</h1><p class="text-gray-600 mb-8">Completa el formulario y te responderemos a la brevedad.</p><form method="POST" action="/contacto/enviar" class="space-y-4"><input type="hidden" name="_csrf_token" value="{{csrf_token}}"><input type="text" name="hp_website" class="hidden" style="display:none;" autocomplete="off" tabindex="-1"><div><label class="block text-sm font-medium text-gray-700 mb-1">Nombre</label><input type="text" name="name" class="w-full border border-gray-300 rounded-lg px-4 py-2" placeholder="Tu nombre" required></div><div><label class="block text-sm font-medium text-gray-700 mb-1">Email</label><input type="email" name="email" class="w-full border border-gray-300 rounded-lg px-4 py-2" placeholder="tu@email.com" required></div><div><label class="block text-sm font-medium text-gray-700 mb-1">Mensaje</label><textarea name="message" rows="5" class="w-full border border-gray-300 rounded-lg px-4 py-2" placeholder="Escribe tu mensaje..." required></textarea></div><button type="submit" class="bg-indigo-600 text-white px-6 py-2.5 rounded-lg font-medium hover:bg-indigo-700 transition-colors">Enviar Mensaje</button></form></section>`,
            contact_2: `<section class="py-16 px-4"><div class="max-w-5xl mx-auto grid md:grid-cols-2 gap-12"><div><h1 class="text-3xl font-bold text-gray-900 mb-4">Información de Contacto</h1><div class="space-y-4 text-gray-600"><p>📍 Dirección: Tu dirección aquí</p><p>📞 Teléfono: +1 234 567 890</p><p>✉️ Email: contacto@tuempresa.com</p><p>🕒 Horario: Lun-Vie 9am - 6pm</p></div></div><div><h2 class="text-2xl font-bold text-gray-900 mb-4">Escríbenos</h2><form method="POST" action="/contacto/enviar" class="space-y-4"><input type="hidden" name="_csrf_token" value="{{csrf_token}}"><input type="text" name="hp_website" class="hidden" style="display:none;" autocomplete="off" tabindex="-1"><input type="text" name="name" class="w-full border border-gray-300 rounded-lg px-4 py-2" placeholder="Nombre" required><input type="email" name="email" class="w-full border border-gray-300 rounded-lg px-4 py-2" placeholder="Email" required><textarea name="message" rows="4" class="w-full border border-gray-300 rounded-lg px-4 py-2" placeholder="Mensaje" required></textarea><button type="submit" class="bg-indigo-600 text-white px-6 py-2.5 rounded-lg font-medium">Enviar</button></form></div></div></section>`,
